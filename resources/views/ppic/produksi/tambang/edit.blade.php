...
@section('title', 'Edit Data Tambang')
...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Edit Data Produksi Tambang</h1>

    <form action="{{ route('produksi.tambang.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
