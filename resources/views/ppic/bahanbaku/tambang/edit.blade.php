...
@section('title', 'Edit Bahan Baku Tambang')

@section('content')
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Edit Data Bahan Baku Tambang</h1>

    <form action="{{ route('bahanbaku.tambang.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('bahanbaku.tambang.index') }}" class="btn btn-secondary">Kembali</a>
    </form>
</div>
@endsection
