...
@section('title', 'Edit Bahan Baku Benang')

@section('content')
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Edit Data Bahan Baku Benang</h1>

    <form action="{{ route('bahanbaku.benang.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('bahanbaku.benang.index') }}" class="btn btn-secondary">Kembali</a>
    </form>
</div>
@endsection
