...
<head>
    <meta charset="utf-8">
    <title>Laporan Hasil Peramalan - Manajer</title>
    <style>
        body {
...
<body>
    ...
    <div class="info">
        ...
        @php
    $tahunData = json_decode($item->tahun, true);
    $tahunString = is_array($tahunData) ? implode(', ', $tahunData) : $item->tahun;
@endphp
<strong>Tahun:</strong> {{ $tahunString }}<br>
